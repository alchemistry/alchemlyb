...
.. After learning the usage patterns in alchemlyb, you will likely find the :ref:`general-examples` useful for learning about more detailed use cases. 
If you desire more technical detail on the underlying components of the library, we advise you visit the :ref:`reference-doc`.
