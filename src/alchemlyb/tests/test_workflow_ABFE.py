...
class Test_automatic_amber:
    ...
    # @pytest.fixture(scope="module")
    # def setup(gmx_benzene_Coulomb_dHdl, gmx_benzene_Coulomb_u_nk, tmp_path_factory):
    #     outdir = tmp_path_factory.mktemp("out")
    #     dir = os.path.dirname(load_ABFE()["data"]["complex"][0])
    #     workflow = ABFE(
    #         units="kcal/mol",
    ...
    #         outdirectory=str(outdir),
    #     )
    #     workflow.u_nk_list = gmx_benzene_Coulomb_u_nk
    #     workflow.dHdl_list = gmx_benzene_Coulomb_dHdl
    #     workflow.u_nk_sample_list = gmx_benzene_Coulomb_u_nk
    #     workflow.dHdl_sample_list = gmx_benzene_Coulomb_dHdl
    #     return workflow, outdir
