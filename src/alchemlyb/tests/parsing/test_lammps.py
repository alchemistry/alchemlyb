...
kwargs_mbar = {
    "1_coul-off": {"indices": [2,3], "ensemble": "npt", "prec": 3, "pressure": pressure,},
    "2_vdw": {"column_dU": 5, "column_U": 4, "indices": [2,3], "ensemble": "npt", "prec": 3, 
              "pressure": pressure, "column_volume": 7,},
    "3_coul-on": { "column_dU": 4, "column_U": 3, "indices": [2,3], "prec": 3,},
}
kwargs_ti = {
    "1_coul-off": {"column_lambda1": 1, "column_dlambda1": 2, "columns_derivative": [8,7]},
    "2_vdw": {"column_lambda1": 1, "column_dlambda1": 2, "columns_derivative": [9,8]},
    "3_coul-on": {"column_lambda1": 1, "column_dlambda1": 2, "columns_derivative": [8,7]},
}
...
def test_beta_from_units():
    ...
    assert_almost_equal(lmp.beta_from_units(T_K, "si"), 2.414323505391137e+20, decimal=4)
...
def test_energy_from_units():
    ...
    assert_almost_equal(lmp.energy_from_units("electron"), 3.3989309217431655e-14, decimal=4)
...
class TestLammpsMbar:
    ...
    def test_u_nk_npt_error(self, data,):
    ...
    def test_u_nk_unknown_ensemble(self, data,):
    ...
    def test_u_nk_nvt_with_pressure(self, data,):
        """Test that initializing u_nk that only known ensembles are accepted
        """
        filenames, kwargs, _ = copy.deepcopy(data)
        kwargs["ensemble"] = "nvt"
    ...
    def test_u_nk_wrong_cols(self, data,):
    ...
    def test_u_nk_wrong_col_type(self, data,):
    ...
    def test_u_nk_col2_type_error(self, data,):
    ...
    def test_u_nk_col_dU_type_error(self, data,):
    ...
    def test_u_nk_col_U_type_error(self, data,):
    ...
    def test_u_nk_col_lambda2_error(self, data,):
        """Test that initializing u_nk that only known ensembles are accepted
        """
        filenames, kwargs, _ = copy.deepcopy(data)
    ...
    def test_u_nk_col_lambda2(self, data,):
        """Test that initializing u_nk that only known ensembles are accepted
        """
        filenames, kwargs, _ = copy.deepcopy(data)
        kwargs["column_lambda2"] = 3
    ...
    def test_u_nk_error_no_file(self, data,):
        """Test error no file
        """
        filenames, kwargs, _ = copy.deepcopy(data)
    ...
    def test_u_nk_inconsistent_lambda(self, data):
        ...
        with pytest.raises(
            ValueError,
            match=r"BAR calculation cannot be performed without the following lambda-lambda prime combinations: \[\(0.6, 0.5\)\]",
        ):
            u_nk = lmp.extract_u_nk(filenames, 300, **kwargs)
...
class TestLammpsTI:
    ...
    def test_dHdl_error_no_file(self, data,):
        """Test error no file
        """
        filenames, kwargs = copy.deepcopy(data)
        filenames.append("test_test_1_1_test_1.txt")
    ...
    def test_dHdl_error_num_cols(self, data,):
        """Test error no file
        """
        filenames, kwargs = copy.deepcopy(data)
...
class TestLammpsH:
    ...
    def data():
        ...
        leg = "2_vdw"
        filenames = dataset["data"]["ti"][leg]
        kwargs = {"column_lambda1": 1, "column_pe": 5, "ensemble": "npt", "pressure": pressure}
        return filenames, kwargs


    def test_H_error_no_glob(self, data,):
        """Test error no file
        """
        filenames, kwargs = copy.deepcopy(data)
    ...
    def test_H_error_no_file(self, data,):
        """Test error no file
        """
        filenames, kwargs = copy.deepcopy(data)
        filenames.append("test_test_1_1_test_1.txt")
    ...
    def test_H_error_npt_nvt_pressure(self, data,):
    ...
    def test_H_error_num_cols(self, data,):
        """Test error no file
        """
        filenames, kwargs = copy.deepcopy(data)
        kwargs = copy.deepcopy(kwargs)
...
class TestLammpsLJDimer_MBAR:
    ...
    def data():
        ...
        filenames = dataset["data"]
        kwargs = {"column_lambda": 1, "column_U_cross": 10, "units": "lj", "prec": 1,
                  "pressure": P_lj, "ensemble": "npt", "column_U": 5}
        return filenames, kwargs
    ...
    def test_u_nk_error_no_path(self, data,):
        """Test error no file
        """
        filenames, kwargs = copy.deepcopy(data)
        filenames = "test_test_1_1_test_1.txt"
    ...
    def test_u_nk_col_type_error(self, data,):
        """Test columns_lambda type error
        """
        filenames, kwargs = copy.deepcopy(data)
        kwargs["column_lambda"] = 'test'
    ...
    def test_u_nk_col_Ucross_type_error(self, data,):
