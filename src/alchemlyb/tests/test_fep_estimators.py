...
class TestMBAR(FEPestimatorMixin):
    ...
    @pytest.fixture(scope="class",
                    params=[(gmx_benzene_coul_u_nk, 3.041, 0.02088),
                            ...
                            (gmx_expanded_ensemble_case_1, 75.804, 0.15535),
                            (gmx_expanded_ensemble_case_2, 75.787, 0.15883),
...
class TestBAR(FEPestimatorMixin):
    ...
    @pytest.fixture(scope="class",
                    params = [(gmx_benzene_coul_u_nk, 3.044, 0.01640),
                              ...
                              (gmx_expanded_ensemble_case_1, 75.868, 0.12142),
                              (gmx_expanded_ensemble_case_2, 75.874, 0.1238),
                              (gmx_expanded_ensemble_case_3, 76.130, 0.09605),
